...
public class OrderHistoryController {
	...
	public ModelAndView registerOrder(@RequestParam("orderCount")int productId,
								 	  @RequestParam("productId")int orderCount,
								 	  ModelAndView mav) {
		//注文履歴テーブルに注文情報を登録する
		orderHistoryDao.insertOrderHistory(orderCount,productId);
